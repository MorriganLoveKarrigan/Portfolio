...
import './index.scss'
import LogoM from '../../../assets/images/m-logo.svg'
...
const Logo = () => {
    ...
    return (<div className='logo-container' ref={bgRef}>
        {/*<img ref={solidLogoRef} className='solid-logo' alt='S' src={LogoM}/>*/}
        <svg width="128px" height="128px" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg"
             aria-hidden="true" role="img"
             className=" svg-container" preserveAspectRatio="xMidYMid meet">
